...
*/
#define     CLOCK_TEST_TIMER_CLOCK      TMR_CLOCK_SOURCE_EXTERNAL_INPUT_PIN
#define     CLOCK_TEST_REFERENCE_FREQ   32768
#define     CLOCK_TEST_TIMER            TMR_ID_7
#define     CLOCK_TEST_INTERRUPT_SOURCE INT_SOURCE_TIMER_7
/*******************************************************************************
  Function:
